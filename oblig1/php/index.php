    ...
    <main>
      <section>
        <form action="loginFromDatabase.php" id="loginForm" method="POST">
          ...
          <input id="loginName" type="text" name="loginUserName" required>
          <label id="loginPass" for="loginPassword">Passord</label>
          <input id="loginPassword" type="password" name="loginUserPassword" required>
        ...
        <form action="userForgotPasswordFromDatabase.php" id="forgotPasswordForm" method="POST">
          ...
          <input id="forgotPasswordEmail" type="text" name="forgotPasswordEmail" required>
          <label for="forgotPasswordOldPassword">Gammelt passord</label>
          <input id="forgotPasswordOldPassword" type="text" name="forgotPasswordOldPassword" required>
          <label for="forgotPasswordNewPassword">Nytt passord</label>
          <input id="forgotPasswordNewPassword" type="password" name="forgotPasswordNewPassword" required>
      ...
      <section>
        ...
        <article id="studentRegister">
          <form action="registerUserToDatabase.php" method="POST">
            ...
            <input id="registerName" type="text" name="registerName" required>
            ...
            <input id="userRegisterStudie" type="text" name="registerStudie">
            <label for="userRegisterYear">Kull:</label>
            <input type="text" minlength="4" maxlength="4" id="userRegisterYear" name="registerYear">
        ...
        <article id="teacherRegister">
          <form name="registration" action="registerLecturerToDatabase.php" method="post" enctype="multipart/form-data">
            ...
            <input type="text" name="registerName" id="navn" required />
            <label for="passord">Passord</label>
            <input type="password" name="registerPassword" id="passord" required />
            <label for="email">Mail</label>
            <input type="email" name="registerEmail" id="email" required />
            <label for="bilde">Bilde</label>
            <input type="file" accept="image/jpeg" name="registerBilde" id="bilde" required />
